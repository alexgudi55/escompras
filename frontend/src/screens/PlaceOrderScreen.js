...
function PlayOrderScreen(props){
    ...
    const itemsPrice = cartItems.reduce((a , c) => a + c.price*c.cantidad, 0);
    ...
    return <div>
        ...
        <div className="placeorder">
            ...
            <div className="placeorder-action">
                <ul>
                    <li>
                        <button className="button-payment" onClick={placeOrderHandler} > Finalizar Compra</button>
                    </li>
                    <li>
